...
export async function GET(context: APIContext) {
	...
	const allItems = [...projectItems, ...writingItems].sort((a, b) => b.pubDate.valueOf() - a.pubDate.valueOf());

	return rss({
		title: 'Szymon Wilczek',
		description: 'Personal writings, essays, manifestos, software projects, and tools by Szymon Wilczek.',
